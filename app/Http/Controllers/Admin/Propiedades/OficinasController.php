...
{    
    public function index()
    {
    	...
    	return view('admin.propiedad.oficinas.index', compact(['MensajePropiedades', 'MensajeContactos', 'NegocioPropietarios', 'listarOficinas']));
    }

    public function list()
    {
    	$list = Propiedad::oficinas();
    	$res['data'] = $list;
    	return $res;
    }
    ...
    public function create()
    {
    	...
    	return view('admin.propiedad.oficinas.create', compact(['MensajePropiedades', 'MensajeContactos', 'ubigeo', 'NegocioPropietarios', 'listarOficinas']));
    }
    ...
    public function store(RegistroRequest $request)
    {
        ...
        {
            $imagen1 = $request->file('imagen1')->store('oficinas','public');
        }else 
        {
        ...
        {
            $imagen2 = $request->file('imagen2')->store('oficinas','public');
        }else 
        {
        ...
        {
            $imagen3 = $request->file('imagen3')->store('oficinas','public');
        }else 
        {
        ...
        {
            $imagen4 = $request->file('imagen4')->store('oficinas','public');
        }else 
        {
    	...
    	return redirect()->route('admin.oficinas.index')->with('success','Se registro nueva propiedad');
    }
    ...
    public function edit($id)
    {
    	...
    	return view('admin.propiedad.oficinas.edit', compact(['MensajePropiedades', 'MensajeContactos', 'propiedad', 'NegocioPropietarios', 'listarOficinas']));
    }
    ...
    public function update(Request $request)
    {
    	...
    	return redirect()->route('admin.oficinas.index')->with('success','La propiedad fue actualizada');
    }
    ...
    public function delete($id)
    {
    	...
    	return redirect()->route('admin.oficinas.index')->with('danger','Se elimino la propiedad');
    }
}
