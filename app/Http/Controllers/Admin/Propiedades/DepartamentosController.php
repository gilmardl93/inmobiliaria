...
{    
    ...
    {
    	return view('admin.propiedad.departamentos.index');
    }

    public function list()
    {
    	$list = Propiedad::with('ubigeo')->departamentos();
    	$res['data'] = $list;
    	return $res;
    }
    ...
    public function create()
    {
    	...
    	return view('admin.propiedad.departamentos.create', compact(['ubigeo']));
    }
    ...
    public function edit($id)
    {
    	...
    	return view('admin.propiedad.departamentos.edit', compact('propiedad'));
    }
