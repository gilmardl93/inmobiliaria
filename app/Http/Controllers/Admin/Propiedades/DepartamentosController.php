...
{    
    public function index()
    {
    	...
    	return view('admin.propiedad.departamentos.index', compact(['MensajePropiedades', 'MensajeContactos', 'NegocioPropietarios', 'listarDepartamentos']));
    }

    public function list()
    {
    	$list = Propiedad::departamentos();
    	$res['data'] = $list;
    	return $res;
    }
    ...
    public function create()
    {
    	...
    	return view('admin.propiedad.departamentos.create', compact(['MensajePropiedades', 'MensajeContactos', 'ubigeo', 'NegocioPropietarios', 'listarDepartamentos']));
    }
    ...
    public function store(RegistroRequest $request)
    {
        ...
        {
            $imagen1 = $request->file('imagen1')->store('departamentos','public');
        }else 
        {
        ...
        {
            $imagen2 = $request->file('imagen2')->store('departamentos','public');
        }else 
        {
        ...
        {
            $imagen3 = $request->file('imagen3')->store('departamentos','public');
        }else 
        {
        ...
        {
            $imagen4 = $request->file('imagen4')->store('departamentos','public');
        }else 
        {
    	...
    	return redirect()->route('admin.departamentos.index')->with('success','Se registro nueva propiedad');
    }
    ...
    public function edit($id)
    {
    	...
    	return view('admin.propiedad.departamentos.edit', compact(['MensajePropiedades', 'MensajeContactos', 'propiedad', 'NegocioPropietarios', 'listarDepartamentos']));
    }
    ...
    public function update(Request $request)
    {
    	...
    	return redirect()->route('admin.departamentos.index')->with('success','La propiedad fue actualizada');
    }
    ...
    public function delete($id)
    {
    	...
    	return redirect()->route('admin.departamentos.index')->with('danger','Se elimino la propiedad');
    }
}
