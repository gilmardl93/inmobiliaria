...
{    
    public function index()
    {
    	...
    	return view('admin.propiedad.terrenos.index', compact(['MensajePropiedades', 'MensajeContactos', 'NegocioPropietarios', 'listarTerrenos']));
    }
    ...
    public function create()
    {
    	...
    	return view('admin.propiedad.terrenos.create', compact(['MensajePropiedades', 'MensajeContactos', 'ubigeo', 'NegocioPropietarios', 'listarTerrenos']));
    }
    ...
    public function store(RegistroRequest $request)
    {
        ...
        {
            $imagen1 = $request->file('imagen1')->store('terrenos','public');
        }else 
        {
        ...
        {
            $imagen2 = $request->file('imagen2')->store('terrenos','public');
        }else 
        {
        ...
        {
            $imagen3 = $request->file('imagen3')->store('terrenos','public');
        }else 
        {
        ...
        {
            $imagen4 = $request->file('imagen4')->store('terrenos','public');
        }else 
        {
    	...
    	return redirect()->route('admin.terrenos.index')->with('success','Se registro nueva propiedad');
    }
    ...
    public function edit($id)
    {
    	...
    	return view('admin.propiedad.terrenos.edit', compact(['MensajePropiedades', 'MensajeContactos', 'propiedad', 'NegocioPropietarios', 'listarTerrenos']));
    }
    ...
    public function update(Request $request)
    {
    	...
    	return redirect()->route('admin.terrenos.index')->with('success','La propiedad fue actualizada');
    }
    ...
    public function delete($id)
    {
    	...
    	return redirect()->route('admin.terrenos.index')->with('danger','Se elimino la propiedad');
    }
}
