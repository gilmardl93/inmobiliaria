...
{    
    ...
    {
    	return view('admin.propiedad.terrenos.index');
    }
    ...
    public function create()
    {
    	...
    	return view('admin.propiedad.terrenos.create', compact(['ubigeo']));
    }
    ...
    public function edit($id)
    {
    	...
    	return view('admin.propiedad.terrenos.edit', compact('propiedad'));
    }
