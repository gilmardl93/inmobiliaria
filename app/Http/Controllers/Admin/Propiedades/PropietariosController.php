...
class PropietariosController extends Controller
{
    public function index()
    {
    	...
    	return view('admin.propiedad.propietarios.index', compact(['MensajePropiedades', 'MensajeContactos', 'NegocioPropietarios', 'listarPropietarios']));
    }

    public function list()
    {
    	$list = Propiedad::Propietarios();
    	$res['data'] = $list;
    	return $res;
    }
    ...
    public function create()
    {
    	...
    	return view('admin.propiedad.propietarios.create', compact(['MensajePropiedades', 'MensajeContactos', 'ubigeo', 'NegocioPropietarios', 'listarPropietarios']));
    }
    ...
    public function store(RegistroRequest $request)
    {
    	...
    	return redirect()->route('admin.propietarios.index')->with('success','Se registro nueva propiedad');
    }
    ...
    public function edit($id)
    {
    	...
    	return view('admin.propiedad.propietarios.edit', compact(['MensajePropiedades', 'MensajeContactos', 'propiedad', 'NegocioPropietarios', 'listarPropietarios']));
    }
    ...
    public function update(Request $request)
    {
    	...
    	return redirect()->route('admin.propietarios.index')->with('success','La propiedad fue actualizada');
    }
    ...
    public function delete($id)
    {
    	...
    	return redirect()->route('admin.propietarios.index')->with('danger','Se elimino la propiedad');
    }
}
