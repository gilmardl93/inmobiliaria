...
@section('titulo') MENSAJES DE CONTACTOS @stop
   		...
   		<div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">MENSAJES DE CONTACTOS</span>
                </div>
                <div class="tools"> </div>
            </div>
...
$('.User').dataTable({
    ...
    "bProcessing": true,
    "sAjaxSource": '{{ url('mensajes-contactos-data') }}',
    ...
    "columnDefs": [
                ...
                },
                {
                    ...
                    'render': function ( data, type, row ) {
                      return ' \
                      <a href="mensajes-contactos-eliminar/'+row.id+' " title="Eliminar"class="btn btn-icon-only red" ><i class="fa fa-trash"></i></a> \
                      ';
                    }
                },
            ],
