   		...
   		<div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <a href="{!! route('admin.propietarios.create') !!}" class="btn dark btn-outline sbold uppercase">NUEVO</a>
                </div>
                <div class="tools"> </div>
            </div>
...
$('.Categoria').dataTable({
    ...
    "bProcessing": true,
    "sAjaxSource": '{{ url('propietarios-data') }}',
    ...
    "columnDefs": [
                ...
                },
                {
                    ...
                    'render': function ( data, type, row ) {
                      return ' \
                      <a href="propietarios-editar/'+row.id+'" title="Editar"class="btn btn-icon-only green-haze" ><i class="fa fa-edit"></i></a> \
                      <a href="propietarios-eliminar/'+row.id+' " title="Eliminar"class="btn btn-icon-only red" ><i class="fa fa-trash"></i></a> \
                      ';
                    }
                },
            ],
