   		...
   		<div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">LOCALES</span>
                    <a href="{!! route('admin.locales.create') !!}" class="btn dark btn-outline sbold uppercase">NUEVO</a>
                </div>
                <div class="tools"> </div>
            </div>
    ...
    "columnDefs": [
                ...
                },
                {
                    ...
                    'render': function ( data, type, row ) {
                      return ' \
                      <a href="locales-editar/'+row.id+'" title="Editar"class="btn btn-icon-only green-haze" ><i class="fa fa-edit"></i></a> \
                      <a href="locales-eliminar/'+row.id+' " title="Eliminar"class="btn btn-icon-only red" ><i class="fa fa-trash"></i></a> \
                      ';
                    }
                },
            ],
