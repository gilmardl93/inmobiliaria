...
@section('titulo') NEGOCIOS CON LOS PROPIETARIOS @stop
   		...
   		<div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">NEGOCIOS CON LOS PROPIETARIOS</span>
                </div>
                <div class="tools"> </div>
            </div>
...
$('.User').dataTable({
    ...
    "bProcessing": true,
    "sAjaxSource": '{{ url('negocio-propietarios-data') }}',
    ...
    "columnDefs": [
                ...
                },
                {
                    ...
                    'render': function ( data, type, row ) {
                      return ' \
                      <a href="negocio-propietarios-descargar/'+row.id+' " title="DESCARGAR" class="btn btn-icon-only blue" ><i class="fa fa-download"></i></a> \
                      ';
                    }
                },
                {
                    ...
                    'render': function ( data, type, row ) {
                      return ' \
                      <a href="negocio-propietarios-eliminar/'+row.id+' " title="ELIMINAR" class="btn btn-icon-only red" ><i class="fa fa-trash"></i></a> \
                       ';
                    }
                },
            ],
