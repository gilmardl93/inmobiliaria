                            ...
                            <div class="light-slide-item">            
                                <div class="clearfix">
                                    ...
                                    <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                        <li data-thumb="{!! asset('page/assets/img/property-1/property1.jpg') !!}"> 
                                            <img src="{!! asset('page/assets/img/property-1/property1.jpg') !!}" />
                                        </li>
                                        <li data-thumb="{!! asset('page/assets/img/property-1/property2.jpg') !!}"> 
                                            <img src="{!! asset('page/assets/img/property-1/property2.jpg') !!}" />
                                        </li>
                                        <li data-thumb="{!! asset('page/assets/img/property-1/property3.jpg') !!}"> 
                                            <img src="{!! asset('page/assets/img/property-1/property3.jpg') !!}" />
                                        </li>
                                        <li data-thumb="{!! asset('page/assets/img/property-1/property4.jpg') !!}"> 
                                            <img src="{!! asset('page/assets/img/property-1/property4.jpg') !!}" />
                                        </li>                                         
                                    </ul>
                                </div>
                            </div>
